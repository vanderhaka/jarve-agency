...
<image_prompt>
  ...
  <style_guide>
    ...
    <rendering_rules>
      ...
      <rule>UI elements (cards, chat bubbles) have soft drop shadows</rule>
    ...
    <composition_rules>
      ...
      <layers>
        ...
        <layer depth="3">Large floating decorative elements (gears, workflow)</layer>
        <layer depth="4">Main character and AI assistant</layer>
  ...
  <!-- ========== THIS IMAGE: Automate the Busywork (AI Automation) ========== -->

  <subject>
    <character>
      <description>Relaxed confident person standing with arms crossed or hands on hips, looking satisfied while automation happens around them</description>
      <pose>Relaxed power pose, arms crossed or one hand on hip, calm and in control, slight lean back</pose>
      <clothing>Teal/mint colored shirt or top, dark navy pants</clothing>
      <hair>Teal/mint colored, stylized modern cut</hair>
    </character>

    <main_prop>Friendly robot assistant or AI avatar - geometric rounded design, white and teal colors, cute dot eyes, small and approachable, floating nearby helping with tasks</main_prop>

    <secondary_props>
      <item>Floating chat bubbles with checkmarks showing resolved conversations</item>
      <item>Connected workflow nodes with arrows showing automation flow</item>
      <item>Clock icon with fast-forward indicator (time saved)</item>
      <item>Document icons being automatically processed</item>
      <item>Gear/cog icons in white</item>
      <item>Task completion progress bar at 100%</item>
    </secondary_props>
  </subject>

  <floating_decorations>
    <item>Gear/cog icons in white and lavender</item>
    <item>Chat bubble icons with checkmarks</item>
    <item>Workflow connection lines with dots</item>
    <item>Lightning bolts suggesting speed</item>
    <item>Magic sparkle effects around the robot</item>
    ...
    <item>Upward arrows with purple-to-teal gradient</item>
  </floating_decorations>

  <mood>
    <feeling>Relieved, empowered, in control</feeling>
    <energy>Calm confidence, effortless efficiency</energy>
    <message>AI handles the busywork while you focus on what matters</message>
  </mood>
  ...
  <negative_prompts>
    ...
    <avoid>Scary or threatening robot designs</avoid>
    <avoid>Terminator-style AI imagery</avoid>
    <avoid>Stressed or overwhelmed person</avoid>
